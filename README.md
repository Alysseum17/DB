...
[cite\_start]**Вимога:** Атомарність атрибутів, відсутність повторюваних груп[cite: 17].
...
[cite\_start]**Вимога:** Відсутність часткових залежностей (неключові атрибути залежать від усього складеного ключа)[cite: 18].
...
[cite\_start]**Вимога:** Відсутність транзитивних залежностей (неключовий атрибут залежить від іншого неключового атрибута)[cite: 20].
...
[cite\_start]В ході аналізу було виявлено таблицю, яка **порушує принципи нормалізації** через зберігання похідних даних[cite: 5].
